...
A profile nothing points at may never be crawled. Link the org from:

- the site footer
- your personal GitHub profile
- your X and LinkedIn bios

---

## Why this one first

Of everything in `LINK-FOUNDATION.md`, this is the only entry that is both free
of anyone else's permission and genuinely aimed at the people who buy this
product. It is also where the open-source URL→source mapper will live, which is
the link that actually moves Domain Rating rather than merely existing.
